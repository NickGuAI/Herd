...
- [index.md](index.md): human docs home.
- [llms.txt](llms.txt): compact agent-readable discovery index.
- [getting-started/quickstart.md](getting-started/quickstart.md): install to
  first useful commander run.
- [troubleshoot.md](troubleshoot.md): first-run and operations recovery map.
