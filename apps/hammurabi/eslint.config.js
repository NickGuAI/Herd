...
const colorAndFontContractRestrictedSyntax = [
  {
    ...
    message: 'Hex color literals are forbidden in apps/hammurabi/{src,modules}/**/*.tsx — use a sumie/washi/ink/accent token. If the slot is missing, extend the palette in src/index.css + tailwind.config.ts. Allowlisted: charts (modules/telemetry/page.tsx), canvas (modules/rpg/**), xterm (modules/agents/page-shell/TerminalView.tsx).',
  },
  {
