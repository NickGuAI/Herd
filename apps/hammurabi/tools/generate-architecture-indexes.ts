...
const features: FeatureMapping[] = [
  ...
  },
  {
    ...
    storage: ['api-keys.keys', 'api-keys.provider-secrets', 'settings.app', 'skills.config', 'skills.history'],
...
const concepts: ConceptMapping[] = [
  ...
  },
  {
    id: 'skill-root',
    name: 'Skill Root',
    meaning: 'Filesystem roots scanned for installed commander skills and skill config/history.',
...
const observations: SourceObservation[] = [
  ...
  },
  {
    ...
    userEffect: 'Users load skills from commander/session UI rather than navigating to a standalone skills management page.',
    evidence: ['src/module-manifest.ts', 'src/module-registry.ts', 'modules/skills/page.tsx', 'modules/agents/components/SkillsPicker.tsx'],
    recommendation: 'Do not infer a standalone skills route unless the module manifest and registry add one.',
  },
  {
