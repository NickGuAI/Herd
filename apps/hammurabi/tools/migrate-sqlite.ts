...
function usage(): string {
  return [
    'Usage: pnpm --filter hammurabi run migrate:sqlite -- --source-root <dir> --db <file> [--backup|--backup=false] [--replace]',
    '',
    'Examples:',
    '  pnpm --filter hammurabi run migrate:sqlite -- --source-root ~/.hammurabi --db ~/.hammurabi/hammurabi.sqlite --backup',
  ].join('\n')
}
