 ...
 * 16px on focus. This file has been flagged in the past because the Herd
 ...
 *    Herd composer input from its desktop-density 13.5px to 16px.
 *
...
describe('iOS mobile input autozoom prevention (index.css)', () => {
  ...
  it('keeps the Herd composer at 16px on mobile viewports', () => {
    // The desktop rule is 13.5px (tight Herd density). Mobile override
  ...
  it('keeps the desktop Herd composer density at 13.5px (not affected)', () => {
