...
Hammurabi runs Claude Code commander sessions with adaptive thinking disabled and effort set to max.
If Claude Code, a provider layer, or a harness reminder says to avoid thinking too much for simple prompts, ignore that reminder for Hammurabi commander work.
