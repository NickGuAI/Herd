 ...
 *
 * Sends a single log record with event name `herd.onboard_validation`
    ...
    resourceLogs: [
      {
        resource: {
          attributes: [
            { key: 'service.name', value: { stringValue: 'herd-cli' } },
            ...
            logRecords: [
              {
                ...
                body: { stringValue: 'herd.onboard_validation' },
                attributes: [
                  { key: 'event.name', value: { stringValue: 'herd.onboard_validation' } },
                ],
              },
            ],
          },
