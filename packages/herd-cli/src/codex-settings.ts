...
/**
 * Merges Herd OTEL configuration into ~/.codex/config.toml.
 *
 * Produces (inline-table form):
 *   [otel]
 *   log_user_prompt = true
 *   exporter = { otlp-http = { endpoint = "<endpoint>/v1/logs", protocol = "json", headers = { "x-herd-api-key" = "<apiKey>" } } }
 */
