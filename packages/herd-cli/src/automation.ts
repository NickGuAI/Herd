...
function printUsage(stdout: Writable): void {
  stdout.write('Usage:\n')
  stdout.write('  herd automation list [--commander <id>] [--trigger schedule|quest|manual]\n')
  stdout.write(
    '  herd automation create --trigger schedule|quest|manual --name <name> --instruction "<text>" [--commander <id>] [--schedule "<expr>"] [--quest-event completed] [--quest-commander <id>] [--description "<text>"] [--skills "a,b"] [--seed-memory "<text>"] [--max-runs <n>] [--timezone <tz>] [--model <model>] [--agent <provider>] [--work-dir <path>] [--machine <id>] [--permission-mode <mode>] [--session-type stream|pty] [--enabled true|false]\n',
  )
  stdout.write(
    '  herd automation update <automation-id> [--trigger schedule|quest|manual] [--name <name>] [--instruction "<text>"] [--commander <id>] [--schedule "<expr>"] [--quest-event completed] [--quest-commander <id>] [--description "<text>"] [--skills "a,b"] [--seed-memory "<text>"] [--max-runs <n>] [--timezone <tz>] [--model <model>] [--agent <provider>] [--work-dir <path>] [--machine <id>] [--permission-mode <mode>] [--session-type stream|pty] [--enabled true|false]\n',
  )
  stdout.write('  herd automation show <automation-id>\n')
  stdout.write('  herd automation history <automation-id> [--limit <n>]\n')
  stdout.write('  herd automation trigger <automation-id>\n')
  stdout.write('  herd automation pause <automation-id>\n')
  stdout.write('  herd automation resume <automation-id>\n')
  stdout.write('  herd automation complete <automation-id>\n')
  stdout.write('  herd automation cancel <automation-id>\n')
  stdout.write('  herd automation delete <automation-id>\n')
}
