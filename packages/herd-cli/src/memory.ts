...
function printUsage(stdout: Writable): void {
  stdout.write('Usage:\n')
  stdout.write('  herd memory save --commander <id> "<fact>" [--fact "<another>"]\n')
  stdout.write('  herd memory export --commander <id>\n')
  stdout.write('  herd memory --type=working_memory append --commander <id> "<text>"\n')
  stdout.write('  herd memory --type=working_memory read --commander <id>\n')
  stdout.write('  herd memory --type=working_memory clear --commander <id>\n')
}
